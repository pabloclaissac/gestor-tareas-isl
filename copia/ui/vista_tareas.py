...
class VistaTareas(Frame):
    ...
    def abrir_formulario(self):
        ...
        fecha_inicio_entry = DateEntry(ventana, width=20)
        plazo_entry = DateEntry(ventana, width=20)
        ...
        Button(ventana, text="Guardar", bootstyle="success", command=guardar).grid(row=4, column=0, columnspan=2, pady=15)
    ...
    def ver_detalle(self):
        ...
        Label(ventana, text="Tarea:", font=("Arial", 12, "bold")).pack(anchor="w", padx=10, pady=(10,0))
        ...
        Label(ventana, text="Acciones a Realizar:", font=("Arial", 12, "bold")).pack(anchor="w", padx=10, pady=(10,0))
        text_acciones = tk.Text(ventana, height=6, wrap="word")
        text_acciones.pack(fill="both", expand=True, padx=10, pady=5)
        text_acciones.insert("1.0", tarea.compromiso or "")
        text_acciones.configure(state="disabled")

        Button(ventana, text="Cerrar", bootstyle="secondary", command=ventana.destroy).pack(pady=10)
    ...
    def editar_tarea(self):
            ...
            Button(ventana, text="Guardar", bootstyle="success", command=guardar_edicion).grid(row=4, column=0, columnspan=2, pady=15)
